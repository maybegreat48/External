...
namespace ext
{
	void view::weapons() {
		...
		components::feature_checkbox("Infinite Ammo", program::features::weapons_infinite_ammo, g->weapons.infinite_ammo);

		ImGui::SameLine();

		components::feature_checkbox("Infinite Clip", program::features::weapons_infinite_clip, g->weapons.infinite_mag);
#if 0
